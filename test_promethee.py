...
if __name__ == '__main__':
    ...
    print("Résultat de Promethee I avec seuil:")
    print("A obtenir : [array([4, 1, 3, 5, 2, 0]), array([4, 5, 2, 1, 3, 0])] , Obtenu :",promethee.promethee_threshold(1, table, [20, 10, 200, 4, 2, 2],["min", "max", "min", "min", "min", "max"]))
    print("Résultat de Promethee II avec seuil:")
    print("A obtenir : [4 5 1 2 3 0] , Obtenu :",promethee.promethee_threshold(2, table, [20, 10, 200, 4, 2, 2],["min", "max", "min", "min", "min", "max"]),"\n")