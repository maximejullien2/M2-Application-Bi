...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("-op", "--operation", default="", help="Définie sur quel fichier, au format ligne, on se trouvera le type d'operation que l'on veut apr critère ( min ou max)")
    ...
    parser.add_argument("-seuil", default="" ,help="Définie quel fichier, au format ligne, on va utiliser pour récupérer les seuil de préférence pour Electre et Prométhee")
    parser.add_argument("-veto", default="" ,help="Définie quel fichier, au format ligne, on va utiliser pour récupérer les vetos pour Electre.")
