...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("-categorie", action="append" ,help="Représente le fichier, au format ligne, ou les données se trouve de la catégorie que l'on veut ajoute")
    parser.add_argument("-categorie_name", action="append", help = "Représente le nom de la colonne que l'on veut ajouter.")
    parser.add_argument("-true_weight", default="", help="Représente le fichier ou se trouve les TrueWeight, au format ligne, que l'on va rajouter au donnée")
    parser.add_argument("-weight", default="", help="Représente le fichier ou se trouve les TrueWeight, au format ligne, que l'on va rajouter au donnée")
